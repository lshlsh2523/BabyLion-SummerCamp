...
export const MESSAGES = {
  ...
  ROLE: {
    title: '*가게 사장님*이신가요,\n*구경*하러 오셨나요?',
    tts: '가게 사장님이신가요, 아니면 구경하러 오셨나요? 아래에서 골라 주세요.',
    ownerBtn: '가게 사장님이에요',
    guestBtn: '그냥 구경할게요',
  },
  SIGNUP: {
    title: '가입 정보를\n입력해 주세요',
    tts: '가입 정보를 입력해 주세요. 이름과 비밀번호, 가게 이름을 넣어 주세요.',
    nameLabel: '이름',
    namePlaceholder: '이름을 입력해 주세요',
    passwordLabel: '비밀번호',
    passwordPlaceholder: '비밀번호를 입력해 주세요',
    storeNameLabel: '가게 이름',
    storeNamePlaceholder: '가게 이름을 입력해 주세요',
    gpsAgree: '가게 위치 확인을 위한 GPS 정보 수집에 동의합니다',
    submitBtn: '가입하기',
  },
  ADDRESS: {
    title: '가게 *주소*를\n말씀해 주세요',
    tts: '가게 주소를 말씀해 주세요. 마이크를 누르고 주소를 또박또박 말씀해 주시면 돼요.',
    hint: '마이크를 누르고\n가게 주소를 말씀해 주세요',
    recordBtn: '눌러서 말하기',
    stopBtn: '눌러서 끝내기',
    listening: '듣고 있어요…',
